...
# Networks
```{r fig1 ,echo=FALSE,fig.align='center',fig.cap="Network of collocations in the Daily Star",out.width="80%"}
knitr::include_graphics('./images/fig2.png')
```
---
class: animated, fadeIn, middle

```{r fig2 ,echo=FALSE,fig.align='center',fig.cap="Network of collocations in The Sun",out.width="80%"}
