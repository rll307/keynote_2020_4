...
```{r fig2 ,echo=FALSE,fig.align='center',fig.cap="Network of collocations in The Sun",out.width="70%"}
knitr::include_graphics('./images/fig3.png')
```
---
class: animated, fadeIn, middle

```{r fig3 ,echo=FALSE,fig.align='center',fig.cap="Network of collocations in The Telegraph",out.width="70%"}
